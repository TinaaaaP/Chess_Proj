...
//Anthony Testing the sort_by_type function
    ...
    Product *tester3 = new Product("Apple", 03, 05, 1999, 22, 10, 2002, 4, 23.3);
    Product *tester4 = new Product("Orange", 03, 05, 2022, 24, 03, 2003, 10, 19);
    Product *tester5 = new Product("Orange", 30, 04, 2003, 02, 06, 2003, 1, 19);
    Product *tester6 = new Product("Orange", 01, 05, 2003, 10, 06, 1999, 7, 19);
